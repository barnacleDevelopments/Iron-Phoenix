...
app.use(
  ...
  _express["default"]["static"](
    _path["default"].join(__dirname, "../public/css")
  )
);
app.use(
  "/",
  _express["default"]["static"](
    _path["default"].join(__dirname, "../public/js")
  )
);
app.use(
  "/",
  _express["default"]["static"](
    _path["default"].join(__dirname, "../public/img")
  )
);
app.use(
  "/",
  _express["default"]["static"](
    _path["default"].join(__dirname, "../public/img/icons")
  )
);
app.use(
  "/",
  _express["default"]["static"](
    _path["default"].join(__dirname, "../public/fonts")
  )
);
app.use(
  "/",
  _express["default"]["static"](_path["default"].join(__dirname, "../"))
